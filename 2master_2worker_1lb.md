### Pre-requisites
------------------
For Kubernetes, we will use 2 control-plane nodes and 2 worker nodes. We will also use 1 servers for HAProxy to provide high availability with IP addess of 192.168.125.89.
